...
Return a list of key-value pairs where the values are the number of times each
...
Return a list of key-value pairs where the values are collections of the
